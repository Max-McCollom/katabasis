// The archived estate world (three.js + react-three-fiber + physics + audio).
// Reachable only at /estate; lazy-loaded from App.jsx so the default Cockpit
// route ships none of this. Preserved per docs/COCKPIT_PLAN.md; the pre-pivot
// tree also lives under the git tag archive/estate-world.
